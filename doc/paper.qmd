...
The paper is structured into sections corresponding to Tasks 1–4, where each section presents the research design choices and assumptions, documents the replication steps, and analyzes the replication results. The concluding remarks are provided in @sec-conclusion.
