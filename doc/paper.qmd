...
date: today
date-format: MMM D, YYYY [\vspace{0cm}] # Adjust the vertical space after the date from 1cm
abstract: |
...
## Research Design Choices and Assumptions - Task 1 {#sec-research_design_assumptions1}
...
## Replication Steps - Task 1 {#sec-replication_steps1}
...
4. **Rank the following factors in order of importance when evaluating earnings announcements (i = most important, v = least important):**
    i) Earnings per share (EPS) compared to analyst forecasts
    ii) Revenue growth
    iii) Management guidance and commentary
    iv) Market reaction on the day of the announcement
    v) Industry trends and macroeconomic conditions
